<template>
  ...
  >
    <div
      class="font-karla text-3xl font-bold px-5 py-2 flex flex-row justify-center text-lightest-slate z-10"
    >
    ...
    <div v-if="!nav" class="block sm:hidden">
      <button
        @click="togglenav()"
        class="px-6 py-4 text-4xl absolute right-4 -top-2 z-10"
      >
        &#9776;
      </button>
    </div>
    ...
    <div v-else class="block sm:hidden">
      <div class="w-full items-center">
        ...
        <nav class="font-ibm w-full flex flex-col items-center">
          <div
            class="absolute flex flex-col p-3 pt-16 top-0 bg-navy w-full right-0"
          >
            <router-link
