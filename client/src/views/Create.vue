<template>
  ...
  <div
    class="create-controls flex flex-col justify-between w-full sm:w-[75%] lg:w-1/2 mx-auto lg relative my-2 py-2"
  >
    <!-- Create pop-up -->
    <div
      v-if="showAdd"
    ...
    >
      ...
      <div class="bg-navy flex">
        <button
          @click="createList()"
          class="w-full h-[40px] font-light font-ibm text-green border-green border-1 rounded hover:bg-green/[0.2]"
        >
          Create
        </button>
        <button
